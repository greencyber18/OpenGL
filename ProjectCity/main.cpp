...
glPopMatrix();
 ...
 x=.85f;  y=.85f;  radius =.07f;
    ...
    glBegin(GL_QUADS); //Metrorail Piller
glColor3ub(49, 59, 51);
glVertex2f(-0.4,0.35);
glVertex2f(-0.5,0.35);
glVertex2f(-0.5,-1.0);
...
glEnd();
   ...
   glBegin(GL_QUADS); //Metrorail Span
glColor3ub(49, 59, 51);
glVertex2f(1.0,0.45);
glVertex2f(-1.0,0.45);
glVertex2f(-1.0,0.35);
...
glEnd();
   ...
   glBegin(GL_LINES); //Metrorail Span
glColor3ub(255, 255, 255);
glVertex2f(0.9,0.45);
glVertex2f(0.9,0.35);
glVertex2f(0.6,0.45);
...
glTranslatef(position5, 0.0f,0.0f);
    ...
    glBegin(GL_QUADS); //Metrorail Body1
glColor3ub(211, 214, 17);
glVertex2f(-0.55,0.4);
glVertex2f(-0.25,0.4);
glVertex2f(-0.25,0.6);
glVertex2f(-0.55,0.6);
...
glEnd();
 ...
 x=-.32f;  y=.43f;  radius =.025f;
    ...
    glBegin(GL_QUADS); //Metrorail Body2
glColor3ub(250, 4, 0);
glVertex2f(-0.2,0.6);
glVertex2f(-0.2,0.4);
glVertex2f(0.08,0.4);
...
glEnd();
 ...
 glBegin(GL_QUADS); //Metrorail Body3
glColor3ub(211, 214, 17);
glVertex2f(0.1,0.4);
glVertex2f(0.4,0.4);
glVertex2f(0.4,0.6);
...
glEnd();
   ...
   glBegin(GL_QUADS); //Metrorail Whistle
glColor3ub(0,0,0);
glVertex2f(0.45,0.57);
glVertex2f(0.45,0.53);
glVertex2f(0.59,0.5);
glVertex2f(0.59,0.62);
glEnd();



                 i;
 x=.2f;  y=.43f;  radius =.05f;
     triangleAmount = 20; //# of triangles used to draw circle
...
glEnd();
   ...
   glBegin(GL_TRIANGLES); //Metrorail Whistle light
